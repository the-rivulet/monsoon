...
export class Comparator {
  ...
  constructor (c: Comparator | string) {
    if(c instanceof Comparator && c.loose === !!true) return c;
...
export class SlugverRange {
  ...
  constructor (range: SlugverRange | Comparator | string) {
...
const testSet = (set, version: Slugver, options) => {
